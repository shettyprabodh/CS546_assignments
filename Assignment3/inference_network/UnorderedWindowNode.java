...
public class UnorderedWindowNode extends WindowNode{
  ...
  public static boolean isInsideWindow(ArrayList<Integer> positions_1, ArrayList<Integer> positions_2, int window_size){
    ...
    // System.out.println("Positions_1:- " + positions_1);
    // System.out.println("Positions_2:- " + positions_2);
    // System.out.println("Common:- " + common);
    // System.out.println("inside_window & double_dipping:- " + inside_window + " : " + double_dipping);
    // System.out.println("===============================================================");
